...
import com.baigehuidi.demo.weixin4j.factory.WeixinFactory;
import com.baigehuidi.demo.weixin4j.factory.defaults.DefaultWeixinFactory;
...
public final class WeixinBuilder {
    ...
    /**
     * 获取一个新的微信构建器   有参 appid和appsecret,name
     *
     ...
     * @return 微信构造器
     */
    public static WeixinBuilder newInstance(String appId, String secret,String name) {
        WeixinBuilder builder = new WeixinBuilder();
        builder.weixin = new Weixin(appId,secret,name);
        return builder;
    }

    /**
     * 外部自定义微信公众号配置   weixinConfig 微信配置.
     *
