...
//    public MyMenu(JSONObject jsonObj) {
//        //初始化一级自定义菜单
...
//            //转成view按钮
//            singleButton = new ViewButton(jsonButton.getString("name"), "https://open.weixin.qq.com/connect/oauth2/authorize?appid="+WeixinInsLoader.getWeixinInstance().getAppId()+"&redirect_uri="+CommonUtil.urlEncodeUTF8(jsonButton.getString("url"))+"&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect");
