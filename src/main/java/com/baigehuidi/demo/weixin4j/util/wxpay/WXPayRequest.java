...
import static com.baigehuidi.demo.weixin4j.util.wxpay.WXPayConstants.USER_AGENT;



/**
 * 微信支付请求,加入了是否需要进行证书,(双向证书)
 */
public class WXPayRequest {
    ...
    private String request(String urlSuffix, String uuid, String data, int connectTimeoutMs, int readTimeoutMs, boolean useCert, boolean autoReport) throws Exception {
        ...
        if(domainInfo == null){
            throw new Exception("IWXPayConfig.getWXPayDomain().getDomain() is empty or null");
        }
        try {
