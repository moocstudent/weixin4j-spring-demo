...
public class WXPayUtil {
     ...
     * @throws Exception
     */
    public static String generateSignatrue(final Map<String, String> data, String key) throws Exception {
    ...
    public static boolean isSignatureValid(String xmlStr, String key) throws Exception {
        ...
        return generateSignatrue(data, key).equals(sign);
    }
