...
public class Configuration {
    ...
    static void init() {
        ...
        defaultProperty.setProperty("weixin4j.token", "ukyozq");
    ...
    /**
     *
     * @return name 微信公众平台名称
     */
    public static String getName(){ return getProperty("weixin4j.name");}

    public static String getName(String name){ return getProperty("weixin4j.name",name);}


    /**
     * 微信开放平台appid和appsecret
     */
    public static String getOpenAppId(){ return getProperty("weixin4j.open.appid"); }
    public static String getOpenAppId(String openAppId){ return getProperty("weixin4j.open.appid",openAppId); }

    public static String getOpenAppSecret(){ return getProperty("weixin4j.open.appsecret"); }
    public static String getOpenAppSecret(String openAppSecret){ return getProperty("weixin4j.open.appsecret",openAppSecret); }
